...
const Calculator = () => {
  ...
  return (
    <div className='min-w-[320px] bg-black flex flex-col gap-4 p-4 rounded-2xl'>
        <div className='overlfow-x-auto bg-[#141414] min-h-[100px] flex items-end justify-end flex-col p-4 rounded-[10px]'>
            <div className={`${showResult ? resultClass : operationClass} `}>{display}</div>
        </div>
